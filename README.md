...
- 11 秒默认采用 8 个清晰动作段：捏细缝、局部展开、上下扫描、三段折叠、三层切片、S 形合并、压缩、收尾。
- 使用 `borderless body-registered transformation ribbon` 机制，让扫描带真正穿过人物身体平面，而不是悬浮屏幕。
- 锁定眼睛、鼻子、嘴、下颌、发际线、衣缝、手腕和五根手指的真实坐标。
- 替代身份只存在于当前可见切片内部；切片移走后，对应区域立即恢复真人，禁止累计或全身变身。
- 初始细缝高度1%–2%，活动横带16%–20%，硬上限22%，宽度不超过人物臂展。
...
- 手势与特效必须同帧因果对应。
- 人物只有一个，身体坐标只有一套。
- 切片外始终保持原始真人，不允许变身结果向外累积。
- 现实背景不随扫描变成完整异世界。
- 折叠的是窄幅扫描场，而不是实体纸片或巨型菱形窗口。
- 默认不使用轴向扭转、快速双扫、光剑、能量束或全身铠甲变身。
