...
```text
调用 $dimensional-rift-scan-ribbon 做一个11秒的视频脚本：
...
校验器检查8段时间轴、三条强制机制短语、自适应构图、全画面坐标连续性、连接式折叠、手部景深、10.2秒有效时长，以及肖像卡片、照片条、固定比例和过长收尾等禁项。
