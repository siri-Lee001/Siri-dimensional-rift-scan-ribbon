# Continuous Folding-Ribbon Lessons

Use this as a behavioral target, not a fixed character template.
...
- Ending: short hand release, blink, snap, or restrained smile

## Required 8-beat behavior

1. Pinch a 1–2% dark slit.
2. Open a wide band across the life-size face.
3. Push one palm toward camera for strong foreshortening.
4. Fold the same band into three or four connected trapezoid panels.
5. Sweep the joined zigzag diagonally while the hands exchange depth.
6. Flatten it into one thin scanning band and make one up/down scan.
7. Reopen one final wide face reveal.
8. Compress and close only during the final 0.8 seconds.

## Lessons from video testing

- Treat the alternate rendering as a sample of the complete camera frame, not a character portrait placed inside a shape.
- The ribbon must include corresponding alternate background beside the face; this prevents portrait-card composition.
